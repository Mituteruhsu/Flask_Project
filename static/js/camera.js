...
class CameraController {
    ...
    updatePreview(result) {
        ...
        // 顯示各階段預覽
        this.canvasExposure?.classList.remove('d-none');
        this.canvasClahe?.classList.remove('d-none');
        // 更新影像資訊
    ...
    clearPreview() {
        ...
        if (this.canvasExposure) this.canvasExposure.classList.add('d-none');
        if (this.canvasClahe) this.canvasClahe.classList.add('d-none');
